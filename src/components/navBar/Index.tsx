    ...
    <div className="w-full h-[8%] border-b border-gray-200 flex items-center justify-between px-4 relative">
      ...
      <div className="flex gap-5">
        ...
        <div className="flex w-max h-full gap-2 justify-center items-center">
          ...
          <h1 className="font-medium text-[14px] md:text-[18px] capitalize flex flex-col lg:hidden"><span>{truncatedName}</span> <span className="font-normal text-gray-600 text-sm text-end">{currentDate}</span></h1>
          <h1 className="font-medium text-[14px] md:text-[18px] capitalize hidden lg:flex flex-col"><span>{fullName}</span> <span className="font-normal text-gray-600 text-sm text-end">{currentDate}</span></h1>
