    ...
    <div className="w-full h-16 border-b border-gray-200 flex items-center justify-between px-4">
      ...
      <div className="flex gap-5">
        ...
        <div className="flex w-max h-full gap-2 justify-center items-center">
          <h1 className="font-medium text-[18px]">Ifeadi Kennedy</h1>
          <span className="rounded-full h-10 w-10 bg-[#d87cdc] text-white font-medium text-[18px] flex justify-center items-center">IK</span>
        </div>
      </div>
    </div>
  )
